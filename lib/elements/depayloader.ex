defmodule Basic.Elements.Depayloader do
  ...
  def_options packets_per_frame: [
      spec: pos_integer,
      description:
        "Position integer, describing how many packets from a single frame. Used to demand the proper number of packets while assembling the frame."
  ]
  ...
  def handle_buffer(:input, buffer, _context, state) do
    ...
    %{"data" => data, "frame_id" => _frame_id, "type" => type, "timestamp" => timestamp } = Regex.named_captures(regex, packet)
